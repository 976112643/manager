...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
 ...
 // function getCellCacheController()
            ...
            foreach ($this->getCellCollection(false) as $cellID) {
                ...
                if (isset($autoSizes[$this->_cellCollection->getCurrentColumn()])) {
                    ...
                    if (! isset($isMergeCell[$this->_cellCollection->getCurrentAddress()])) {
                        // Calculated value
                        // To formatted string
                        $cellValue = PHPExcel_Style_NumberFormat::toFormattedString($cell->getCalculatedValue(), $this->getParent()
     ...
     *
     * @param string $row
     *            Return the data highest column for the specified row,
     ...
     *
     * @param string $row
     *            Return the highest data column for the specified row,
     ...
     *
     * @param string $column
     *            Return the highest data row for the specified column,
