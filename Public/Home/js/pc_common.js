	...
	Validform.util={
		dataType:{
			...
			"gt":function(gets,obj,curform,regxp){//大于
				return true && (obj.data('gt_than') != undefined && gets > obj.data('gt_than'));
			},
...
$(document).ready(function(){
	...
	*/
	...
	$(document).on("click",".js_tab",function(){
		...
		$(obj+" > .js_tab_content").eq(tab_index).addClass('active').siblings('.js_tab_content').removeClass("active");
	})
